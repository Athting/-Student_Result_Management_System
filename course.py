...
class Course_class:
    def __init__(self, root):
        ...
        # Labels
        lbl_course_name = Label(self.root, text="Course Name", font=("goudy old style", 15, "bold"), bg="white")
        ...
        lbl_search_course_name = Label(self.root, text="Search Course Name", font=("goudy old style", 15, "bold"), bg="white")
        lbl_search_course_name.place(x=720, y=60)
        
        txt_search_course_name = Entry(self.root, textvariable=self.var_search, font=("goudy old style", 15, "bold"), bg="lightyellow")
        ...
        self.C_frame.place(x=700, y=100, width=470, height=340)

        scrolly = Scrollbar(self.C_frame, orient=VERTICAL)
        scrollx = Scrollbar(self.C_frame, orient=HORIZONTAL)
        
        self.course_table = ttk.Treeview(self.C_frame, columns=("Course id", "name", "duration", "charges", "description"), xscrollcommand=scrollx.set, yscrollcommand=scrolly.set)
        ...
        self.course_table.column("Course id", width=65)
